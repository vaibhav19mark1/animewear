...
const MyAccount = () => {
  ...
  const handlePasswordSubmit = async () => {
    if (password == cpassword) {
      let data = { token: user.token, currpassword, password, cpassword };
  ...
  return (
    <div className="container mx-auto my-8">
      ...
      <div className="mx-4">
        ...
        <button onClick={handleUserSubmit} className="disabled:bg-red-300 text-white m-2 mb-5 bg-red-500 border-0 py-2 px-2 focus:outline-none hover:bg-red-600 rounded text-sm">
          Submit
        </button>
      </div>
      <div className="mx-4">
        ...
        <div className="flex my-4">
          <div className="px-2 w-1/3">
            <div>
              <label htmlFor="currpassword" className="leading-7 text-sm text-gray-600">
                Current Password
              </label>
              <input onChange={handleChange} value={currpassword} type="password" id="currpassword" name="currpassword" className="w-full bg-white rounded border border-gray-300 focus:border-red-500 focus:ring-2 focus:ring-red-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
            </div>
          </div>
          <div className="px-2 w-1/3">
            <div>
          ...
          <div className="px-2 w-1/3">
            <div>
              ...
              <input onChange={handleChange} value={cpassword} type="text" id="cpassword" name="cpassword" className="w-full bg-white rounded border border-gray-300 focus:border-red-500 focus:ring-2 focus:ring-red-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
            </div>
          </div>
        </div>
        <button onClick={handlePasswordSubmit} className="disabled:bg-red-300 text-white m-2 bg-red-500 border-0 py-2 px-2 focus:outline-none hover:bg-red-600 rounded text-sm">
          Submit
        </button>
      </div>
    </div>
