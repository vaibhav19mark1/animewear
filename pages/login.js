    ...
    <div className="min-h-screen">
      ...
      <div className="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md space-y-8">
          <div>
            {/* <img className="mx-auto h-1/12 w-auto" src="/circlelogo.png" alt="CodesWear.com" /> */}
          ...
          <form className="mt-8 space-y-6" method="POST" onSubmit={handleSubmit}>
            ...
            <div className="-space-y-px rounded-md shadow-sm">
              ...
              <div>
                ...
                <input onChange={handleChange} value={password} id="password" name="password" type="password" autoComplete="current-password" required className="relative block w-full appearance-none rounded-none rounded-b-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-red-500 focus:outline-none focus:ring-red-500 sm:text-sm" placeholder="Password" />
              </div>
            </div>

            <div className="flex items-center justify-between">
              <div className="text-sm">
                <Link href={"/forgot"} className="font-medium text-red-600 hover:text-red-500">
