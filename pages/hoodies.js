  ...
  return (
    <>
      ...
      <div className="min-h-screen">
        <h1 className="text-center m-3 text-2xl md:m-5 md:text-4xl font-semibold">Hoodies and Sweatshirts</h1>
        <section>
          ...
          <div className="lg:w-1/5 md:w-1/3 w-1/2 border border-gray-300 md:border-none md:shadow-lg m-0 md:m-5 md:transition md:ease-in-out md:hover:-translate-y-1 md:hover:scale-110 md:duration-300">
              <Link href={"#"} className="block relative h-auto md:h-72 overflow-hidden">
                <img src="https://rukminim1.flixcart.com/image/612/612/xif0q/sweatshirt/y/9/m/m-portgas-d-ace-one-piece-hoodie-for-men-joy-happiness-original-imagksfejfzxfmgb.jpeg?q=70" alt="tshirt-image" className="object-top block" />
              </Link>
